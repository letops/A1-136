# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-03-15 21:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edition_date', models.DateTimeField(auto_now=True, verbose_name='Last edition date')),
                ('hidden', models.BooleanField(default=False, verbose_name='Hidden')),
                ('cluster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MainAPP.Cluster', verbose_name='Cluster')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MainAPP.Question', verbose_name='Question'),
        ),
    ]
