# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-04-01 21:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style', models.IntegerField(choices=[(0, 'Radio'), (1, 'Priority')], default=0, verbose_name='Style')),
                ('edition_date', models.DateTimeField(auto_now=True, verbose_name='Last edition date')),
                ('hidden', models.BooleanField(default=False, verbose_name='Hidden')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='selections', to='MainAPP.Question', verbose_name='Question')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='render',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='render', to=settings.AUTH_USER_MODEL, verbose_name='User'),
        ),
        migrations.AddField(
            model_name='position',
            name='user',
